...
const sidebarMenuButtonVariantMap: Record<string, string> = {
  default: "hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
  outline:
    "bg-background shadow-[0_0_0_1px_hsl(var(--sidebar-border))] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground hover:shadow-[0_0_0_1px_hsl(var(--sidebar-accent))]",
};

const sidebarMenuButtonSizeMap: Record<string, string> = {
  default: "h-8 text-sm",
  sm: "h-7 text-xs",
...
function sidebarMenuButtonVariants({
  ...
  return cn(
    ...
    sidebarMenuButtonVariantMap[variant] ?? "",
    sidebarMenuButtonSizeMap[size] ?? "",
    className,
  );
}
